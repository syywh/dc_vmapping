...
namespace vill {
    ...
    // 计算当前帧和上一帧的平均视差
    public:
	double SearchParralax(Frame &CurrentFrame, KeyFrame *pLastKF);	  
    ...
    public:
         ...
         * @see SearchByBoW()
         */
        int SearchByProjection(int & tried, Frame &CurrentFrame, const Frame &LastFrame, const float th, const bool bMono,
