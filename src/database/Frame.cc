...
//         mNavStatePrior = frame.mNavStatePrior;
	...
	void Frame::setLaserPose(const Matrix4f& Tlw)
	{
		mTlaserpose = Tlw;
	}
	
	Matrix4f Frame::getLaserPose()
	{
		return mTlaserpose;
	}
	
	void Frame::setLaserposeTimestamp(const double& t)
	{
		mLaserposeTimestamp = t;
	}

	double Frame::getLaserposeTimestamp()
	{
		return mLaserposeTimestamp;
	}
